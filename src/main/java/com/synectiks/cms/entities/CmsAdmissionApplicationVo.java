...
public class CmsAdmissionApplicationVo implements Serializable {
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(getTotalReceived(), that.getTotalReceived())
				...
				&& Objects.equals(getAlternateMobileNumber(),
						that.getAlternateMobileNumber())
	...
	@Override
	public int hashCode() {
		return Objects.hash(getTotalReceived(), getTotalInprocess(), getTotalDeclined(),
				getTotalAccepted(), getId(), getAdmissionStatus(), getStudentName(),
				getStudentMiddleName(), getStudentLastName(), getFatherName(),
				getFatherMiddleName(), getFatherLastName(), getMotherName(),
				getMotherMiddleName(), getMotherLastName(), getContactNumber(),
				getAlternateMobileNumber(), getDateOfBirth(), getEmail(), getSex(),
				getComments(), getApplicationId(), getUploadPhoto(), getCourse(),
				getAdmissionDate(), getAdmissionEnquiry(), getAcademicHistory(),
				getDocuments(), getBranch(), getBatch(), getState(), getCity(),
				getCountry(), getDepartment(), getAcademicyear(), getAcademicyearId(),
				getAdmissionEnquiryId(), getAcademicHistoryId(), getDocumentsId(),
				getBranchId(), getBatchId(), getStateId(), getCityId(), getCountryId(),
				getDepartmentId(), getStrDateOfBirth(), getStrAdmissionDate());
	}

	@Override
	public String toString() {
		return "CmsAdmissionApplicationVo{" + "totalReceived=" + totalReceived
				+ ", totalInprocess=" + totalInprocess + ", totalDeclined="
				+ totalDeclined + ", totalAccepted=" + totalAccepted + ", id=" + id
				+ ", admissionStatus=" + admissionStatus + ", studentName='" + studentName
				+ '\'' + ", studentMiddleName='" + studentMiddleName + '\''
				+ ", studentLastName='" + studentLastName + '\'' + ", fatherName='"
				+ fatherName + '\'' + ", fatherMiddleName='" + fatherMiddleName + '\''
				+ ", fatherLastName='" + fatherLastName + '\'' + ", motherName='"
				+ motherName + '\'' + ", motherMiddleName='" + motherMiddleName + '\''
				+ ", motherLastName='" + motherLastName + '\'' + ", contactNumber='"
				+ contactNumber + '\'' + ", alternateMobileNumber='"
				+ alternateMobileNumber + '\'' + ", dateOfBirth=" + dateOfBirth
				+ ", email='" + email + '\'' + ", sex=" + sex + ", comments='" + comments
				+ '\'' + ", applicationId=" + applicationId + ", uploadPhoto='"
				+ uploadPhoto + '\'' + ", course=" + course + ", admissionDate="
				+ admissionDate + ", admissionEnquiry=" + admissionEnquiry
				+ ", academicHistory=" + academicHistory + ", documents=" + documents
				+ ", branch=" + branch + ", batch=" + batch + ", state=" + state
				+ ", city=" + city + ", country=" + country + ", department=" + department
				+ ", academicyear=" + academicyear + ", academicyearId=" + academicyearId
				+ ", admissionEnquiryId=" + admissionEnquiryId + ", academicHistoryId="
				+ academicHistoryId + ", documentsId=" + documentsId + ", branchId="
				+ branchId + ", batchId=" + batchId + ", stateId=" + stateId + ", cityId="
				+ cityId + ", countryId=" + countryId + ", departmentId=" + departmentId
				+ ", strDateOfBirth='" + strDateOfBirth + '\'' + ", strAdmissionDate='"
				+ strAdmissionDate + '\'' + '}';
	}
}
