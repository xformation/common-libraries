...
public class CmsHolidayVo {
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, holidayDesc, holidayDate, holidayStatus, academicyear,
				strHolidayDate);
	}

	@Override
	public String toString() {
		return "CmsHolidayVo{" + "id=" + id + ", holidayDesc='" + holidayDesc + '\''
				+ ", holidayDate=" + holidayDate + ", holidayStatus=" + holidayStatus
				+ ", academicyear=" + academicyear + ", strHolidayDate='" + strHolidayDate
				+ '\'' + '}';
	}
}
