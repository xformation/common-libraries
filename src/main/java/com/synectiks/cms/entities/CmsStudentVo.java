...
public class CmsStudentVo implements Serializable {
	...
	public void setStrDisabilityCertificateIssueDate(
			String strDisabilityCertificateIssueDate) {
	...
	public String toString() {
		return "CmsStudentVo [id=" + id + ", studentName=" + studentName
				+ ", studentMiddleName=" + studentMiddleName + ", studentLastName="
				+ studentLastName + ", fatherName=" + fatherName + ", fatherMiddleName="
				+ fatherMiddleName + ", fatherLastName=" + fatherLastName
				+ ", motherName=" + motherName + ", motherMiddleName=" + motherMiddleName
				+ ", motherLastName=" + motherLastName + ", studentAadharNo="
				+ studentAadharNo + ", studentPanNo=" + studentPanNo
				+ ", studentSocialSecurityNo=" + studentSocialSecurityNo
				+ ", studentTaxReferenceNo=" + studentTaxReferenceNo + ", studentBplNo="
				+ studentBplNo + ", studentDrivingLicenseNo=" + studentDrivingLicenseNo
				+ ", studentPassportNo=" + studentPassportNo + ", dateOfBirth="
				+ dateOfBirth + ", placeOfBirth=" + placeOfBirth + ", religion="
				+ religion + ", caste=" + caste + ", subCaste=" + subCaste + ", age="
				+ age + ", sex=" + sex + ", studentLocalAddress=" + studentLocalAddress
				+ ", studentPermanentAddress=" + studentPermanentAddress + ", city="
				+ city + ", state=" + state + ", country=" + country + ", pinCode="
				+ pinCode + ", studentPrimaryCellNumber=" + studentPrimaryCellNumber
				...
				+ emergencyContactLandLinePhoneNumber + ", emergencyContactEmailId="
				+ emergencyContactEmailId + ", studentImagePath=" + studentImagePath
				+ ", admissionNo=" + admissionNo + ", enrollmentNo=" + enrollmentNo
				+ ", rollNo=" + rollNo + ", studentType=" + studentType
				+ ", fatherCellNumber=" + fatherCellNumber + ", fatherEmailId="
				+ fatherEmailId + ", fatherOccupation=" + fatherOccupation
				...
				+ ", fatherAadharNo=" + fatherAadharNo + ", fatherPanNo=" + fatherPanNo
				+ ", fatherSocialSecurityNo=" + fatherSocialSecurityNo
				+ ", fatherTaxReferenceNo=" + fatherTaxReferenceNo + ", fatherBplNo="
				+ fatherBplNo + ", fatherDrivingLicenseNo=" + fatherDrivingLicenseNo
				+ ", fatherPassportNo=" + fatherPassportNo + ", fatherImagePath="
				+ fatherImagePath + ", motherCellNumber=" + motherCellNumber
				+ ", motherEmailId=" + motherEmailId + ", motherOccupation="
				+ motherOccupation + ", motherOfficeEmailId=" + motherOfficeEmailId
				...
				+ ", motherAadharNo=" + motherAadharNo + ", motherPanNo=" + motherPanNo
				+ ", motherSocialSecurityNo=" + motherSocialSecurityNo
				+ ", motherTaxReferenceNo=" + motherTaxReferenceNo + ", motherBplNo="
				+ motherBplNo + ", motherDrivingLicenseNo=" + motherDrivingLicenseNo
				+ ", motherPassportNo=" + motherPassportNo + ", motherImagePath="
				+ motherImagePath + ", guardianName=" + guardianName
				+ ", guardianMiddleName=" + guardianMiddleName + ", guardianLastName="
				+ guardianLastName + ", guardianAddress=" + guardianAddress
				+ ", guardianCellNumber=" + guardianCellNumber
				+ ", guardianLandLinePhoneNumber=" + guardianLandLinePhoneNumber
				+ ", guardianEmailId=" + guardianEmailId + ", guardianOccupation="
				+ guardianOccupation + ", guardianOfficeEmailId=" + guardianOfficeEmailId
				...
				+ guardianOfficeLandLinePhoneNumber + ", guardianImagePath="
				+ guardianImagePath + ", isGuardianSponsorAgency="
				+ isGuardianSponsorAgency + ", sponsorAgencyName=" + sponsorAgencyName
				...
				+ sponsorAgencyAppointeeOfficeAddress + ", isPhysicallyChallenged="
				+ isPhysicallyChallenged + ", detailsOfDisability=" + detailsOfDisability
				...
				+ ", percentagOfDisability=" + percentagOfDisability + ", bloodGroup="
				+ bloodGroup + ", vaccinationDetails=" + vaccinationDetails
				+ ", otherMedicalDetails=" + otherMedicalDetails + ", status=" + status
				+ ", createdBy=" + createdBy + ", createdOn=" + createdOn + ", updatedBy="
				+ updatedBy + ", updatedOn=" + updatedOn + ", comments=" + comments
				+ ", department=" + department + ", batch=" + batch + ", section="
				+ section + ", branch=" + branch + ", departmentId=" + departmentId
				+ ", batchId=" + batchId + ", sectionId=" + sectionId + ", branchId="
				+ branchId + ", strCreatedOn=" + strCreatedOn + ", strUpdatedOn="
				+ strUpdatedOn + ", strDisabilityCertificateIssueDate="
				+ strDisabilityCertificateIssueDate + ", strDateOfBirth=" + strDateOfBirth
				+ "]";
	}
